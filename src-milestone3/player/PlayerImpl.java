...
public class PlayerImpl implements Player {
   ...
   * @return {@code true} if the player moved the pet, {@code false} otherwise
   */
  public boolean takeHumanTurn(World world, List<PlayerImpl> allPlayers) {
   ...
   */
  public boolean takeAiTurn(World world, List<PlayerImpl> allPlayers) {
   ...
   */
  public void autoMoveToNeighbor() {
   ...
   */
  public boolean movePet(World world) {
   ...
   */
  public void selectAndMoveToNeighbor() {
    List<ImSpace> neighbors = currentSpace.getNeighbors();
    if (neighbors.isEmpty()) {
