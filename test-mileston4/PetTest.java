...
public class PetTest {
  ...
  public void setUp() {
    ...
    // Create an ImTargetCharacter instance
    owner = new TargetCharacter("Doctor Lucky", 100, 0);

    // Initialize the Pet
    pet = new Pet("Buddy", owner, initialSpace);
  }
  ...
  /**
   * Tests that {@code getOwnerName()} returns the correct owner's name.
   */
  @Test
  public void testGetOwnerName() {
    assertEquals("Doctor Lucky", pet.getOwnerName());
  }

  /**
   * Tests that {@code getCurrentSpace()} returns the initial space.
   */
  @Test
